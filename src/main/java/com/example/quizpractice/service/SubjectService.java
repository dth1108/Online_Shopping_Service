...
public interface SubjectService {
     ...
     */
    Subject save(Subject subject,String username);
     ...
     * @return the persisted entity.
     */
    Subject update(String id,Subject subject, String username);
     ...
     * @return the entity.
     */
    Optional<Subject> findOne(String id);
    ...
    void validationCommon(Subject subject);
}
